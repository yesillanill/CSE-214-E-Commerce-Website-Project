...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> registerIndividual(@RequestBody IndividualRegisterDTO dto) {
        return ResponseEntity.ok(authService.registerIndividual(dto));
    }

    @PostMapping("/register/store")
    public ResponseEntity<AuthResponse> registerStore(@RequestBody StoreRegisterDTO dto) {
        return ResponseEntity.ok(authService.registerStore(dto));
    }

    @PostMapping("/login/email")
    public ResponseEntity<AuthResponse> loginEmail(@RequestBody EmailLoginDTO dto) {
        return ResponseEntity.ok(authService.loginWithEmail(dto));
    }

    @PostMapping("/login/phone")
    public ResponseEntity<AuthResponse> loginPhone(@RequestBody PhoneLoginDTO dto) {
